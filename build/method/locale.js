var messages = {
'线上B类展会视觉形式探索': 'Exploring visual forms in online category B exhibitions',
...
'目前B类线上展会视觉形式': 'Current visual forms in B category online exhibitions',
'2.5d 场景在UBM线上展会的应用': '2.5d Applications of scenarios in UBM online exhibitions',
'展会分析': 'Exhibition Analysis',
'行业属性': 'Industry Attributes',
'涵盖了皮革/服装/面料/饰品/鞋包行业的综合型展销会。': 'Combined trade fair that covers the leather/fashion/textile/jewelry/shoes & bag industries.',
'目标人群': 'Target Audience',
'从制造商到零售商等各类专业人群。': 'Professionals in the manufacturing industry, retail, and other sectors.',
'展会特点': 'Exhibition Characteristics',
'展会偏向展销性质，展位样式面积统一标准，保证最佳坪效比，固定标准的逛展路径。': 'The exhibition is oriented towards quality, exhibition booths areas are standardized to optimize floor usage, browsing pathways are fixed.',
