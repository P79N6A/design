...
'设计原则并不是⼀组严格的法则，它是⼀个设计的基础指引，帮助你在需要做设计决，策时降低不确定性。': 'The design principles are not a set of strict rules but a basic guide for design, which help you reduce uncertainty when making a design decision.',
...
'打磨设计细节以提升⽤户体验': 'Refine design details to improve user experience',
...
'清晰 & 简洁': 'Clear & Concise',
'让设计在准确表达的基础上尽量简单': 'Simple design is preferred, on the basis of accurate expression',
'⽤户能清楚准确地感知和认知到⽬标信息，并拥有正确的预期；不受到⼲扰': 'Users can clearly and accurately perceive and recognize the target information to develop appropriate expectations without no distraction.',
'⽤户成⻓': 'User Growth',
...
'减少跨境贸易带来的疏离感': 'Reducing sense of alienation brought by cross-border trade',
'⽆距离感指的是': 'No Sense of Distance refers to:',
'地理上⽆距离，在服务和产品层⾯符合⽤户的本地化⼼智。': 'No geographical distance - align with users’ initiative for localization at both service and product levels.',
'⼼理上⽆距离，在⽤户⼼理上建⽴⼀种贴⼼，可靠的感觉。': 'No psychological distance - create a considerate and reliable feeling.',
'重要性：': 'Importance:',
